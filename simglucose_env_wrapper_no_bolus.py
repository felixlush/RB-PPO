...
class SimglucoseWrapperNoBolus(gym.Wrapper):
    ...
    def step(self, action):
        ...
        # For ablation: no deterministic meal bolus, but still allow residual corrections
        total_insulin_delivered, bolus_rate, bolus_units = calculate_insulin_delivered(
            0.0,  # no rule-based bolus contribution
            gate,
